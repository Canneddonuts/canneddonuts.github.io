...
Module['FS_createPath']("/assets", "bgm", true, true);
Module['FS_createPath']("/assets", "gfx", true, true);
Module['FS_createPath']("/assets", "lvls", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/bgm/theme1.ogg", "start": 0, "end": 1060139, "audio": 1}, {"filename": "/assets/gfx/background.png", "start": 1060139, "end": 1062348}, {"filename": "/assets/gfx/disc.png", "start": 1062348, "end": 1062747}, {"filename": "/assets/gfx/plyr.png", "start": 1062747, "end": 1063800}, {"filename": "/assets/gfx/spike.png", "start": 1063800, "end": 1064085}, {"filename": "/assets/gfx/tile.png", "start": 1064085, "end": 1064403}, {"filename": "/assets/lvls/level1.bin", "start": 1064403, "end": 1065469}, {"filename": "/assets/lvls/level2.bin", "start": 1065469, "end": 1065815}, {"filename": "/assets/lvls/level3.bin", "start": 1065815, "end": 1066281}, {"filename": "/assets/lvls/level4.bin", "start": 1066281, "end": 1067197}], "remote_package_size": 1067197});

  })();

// end include: /tmp/tmppfj0lweb.js
// include: /tmp/tmpxudoe2ib.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpxudoe2ib.js
// include: /tmp/tmpyad7r21v.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpyad7r21v.js
...
var ASM_CONSTS = {
 ...
 130770: ($0) => { return miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 130836: ($0) => { var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 131229: ($0) => { miniaudio.untrack_device_by_index($0); },  
 131272: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = miniaudio.device_state.started; },  
 131397: ($0) => { var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = miniaudio.device_state.stopped; }
};
